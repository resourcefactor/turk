        ...
        if item_map.get(item):
            ...
            if qty_dict.bal_qty:
                ...
                boxes, pieces = calculate_boxes_and_pieces(
                    qty_dict.bal_qty, item_doc.boxes, item_doc.pieces
                )
            # boxes = 1
            # pieces = 1
            ...
            #     pieces = (
            #         qty_dict.bal_qty
            #         / (item_map[item]["boxes"] / item_map[item]["pieces"])
            #     ) % item_map[item]["pieces"]
...
def get_item_details(items, sle, filters):
    ...
    if filters.get("show_variant_attributes", 0) == 1:
        ...
        item_details = {
            k: v.update(variant_values.get(k, {})) for k, v in item_details.items()
        }
